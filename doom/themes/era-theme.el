...
(def-doom-theme era
  ...
  ((font-lock-comment-face :foreground comments :weight 'bold)
   ...
   (magit-diff-added :foreground (doom-darken green 0.2) :background (doom-blend green bg 0.15))
   (magit-diff-added-highlight :foreground green :background (doom-blend green bg 0.25) :bold bold)
   (magit-diff-removed :foreground (doom-darken red 0.2) :background (doom-blend red bg 0.15))
