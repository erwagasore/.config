...
;; Hide menu-bar (Doom already does this, but explicit for clarity)
(menu-bar-mode -1)
...
(setq auto-revert-interval 5
      auto-revert-avoid-polling t)  ; Use file notifications instead of polling
...
(use-package! pi-coding-agent
  ...
  (setq pi-coding-agent-input-window-height 10        ; Height of input window
...
(map! :leader
      (:prefix ("o p" . "pi-coding-agent")
       ...
       :desc "New session" "n" #'pi-coding-agent-new-session
       :desc "Resume session" "r" #'pi-coding-agent-resume-session
       :desc "Quit session" "q" #'pi-coding-agent-quit
       :desc "Reload session" "R" #'pi-coding-agent-reload
       :desc "Set session name" "N" #'pi-coding-agent-set-session-name
       :desc "Fork session" "f" #'pi-coding-agent-fork
       :desc "Export session" "e" #'pi-coding-agent-export-html
       :desc "Compact session" "c" #'pi-coding-agent-compact
       :desc "Show stats" "s" #'pi-coding-agent-session-stats
       :desc "Select model" "m" #'pi-coding-agent-select-model
       :desc "Toggle thinking" "t" #'pi-coding-agent-cycle-thinking
       :desc "Open menu" "p" #'pi-coding-agent-menu
       :desc "Copy last message" "y" #'pi-coding-agent-copy-last-message))
#+end_src
